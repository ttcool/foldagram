function task_done(id){
		...
		$.get("/todos/done/"+id, function(data) {
	...
	function delete_task(id){
		...
		$.get("/todos/delete/"+id, function(data) {
	...
	if(title){
	  	...
	  	$.post("/todos/add", {title: title}).done(function(data) {
	...
	if(title){
	  	...
	  	$.post("/todos/update/"+task_id, {title: title}).done(function(data) {
