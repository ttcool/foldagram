            ...
            <div class="nav-collapse">
                <ul class="nav">
                    ...
                    <ul class="dropdown-menu">
                        <li>{{ link_to('', 'Manage Orders') }}</li>
                        <li>{{ link_to('', 'Export Orders') }}</li>
                    </ul>
                    </li>
                    <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">Manage Price <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li>{{ link_to('', 'Manage Price') }}</li>
                        <li>{{ link_to('', 'Add Price') }}</li>
                    </ul>
                    </li>
                    <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">User Management <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>{{ link_to('', 'Manage User') }}</li>
                            <li>{{ link_to('', 'Add User') }}</li>
                            <li>{{ link_to('', 'Give User Credit') }}</li>
                            <li>{{ link_to('', 'User purchase Credit Order') }}</li>
                        </ul>
                    </li>
                </ul>
                <!-- End Master Report -->
