...
<body>
    ...
    <div class="container">
      ...
      <a class="navbar-brand" href="/album/all">Awesome Albums</a>
      ...
      <div class="col-lg-3">
        <div class="thumbnail" style="max-height: 350px;min-height: 350px;">
          ...
          <div class="caption">
            ...
            <a href="{{URL::route('delete_image_album',array('id'=>$photo->id))}}" onclick="return confirm('Are you sure?')"><button type="button" class="btn btn-danger btn-small">Delete Image</button></a>
