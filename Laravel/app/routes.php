...
Route::get('users/adduser',array('as'=>'add_user','uses'=>'UsersController@getadduser'));

Route::get('adminuser', array("as"=>'adminuser', 'uses'=> 'UsersController@getindex'));
Route::get('admin/logout', array("as"=>'adminlogout', 'uses'=> 'UsersController@Logout'));
